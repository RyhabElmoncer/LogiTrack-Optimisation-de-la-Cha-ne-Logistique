...
let CommandesController = class CommandesController {
    ...
    findOne(id) { return this.commandesService.findOne(+id); }
    create(body) { return this.commandesService.create(body); }
    valider(id) { return this.commandesService.valider(+id); }
    bloquer(id) { return this.commandesService.bloquer(+id); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CommandesController.prototype, "valider", null);
__decorate([
    (0, common_1.Put)(':id/bloquer'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CommandesController.prototype, "bloquer", null);
