...
let UtilisateursController = class UtilisateursController {
    ...
    findOne(id) { return this.utilisateursService.findOne(+id); }
    create(body) { return this.utilisateursService.create(body); }
    update(id, body) { return this.utilisateursService.update(+id, body); }
    remove(id) { return this.utilisateursService.remove(+id); }
};
